...
class LaratrustSeeder extends Seeder
{
    ...
    public function truncateLaratrustTables()
    {
        ...
        $usersTable = (new \App\Domains\Access\Models\User)->getTable();
        $rolesTable = (new \App\Domains\Access\Models\Role)->getTable();
        $permissionsTable = (new \App\Domains\Access\Models\Permission)->getTable();
